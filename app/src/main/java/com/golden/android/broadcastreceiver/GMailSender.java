...
public class GMailSender extends javax.mail.Authenticator {
    ...
    public synchronized void sendMail(String subject, String body,
                                      ...
                                      String logFilePath, String x) throws Exception {
        ...
        if (fileExists) {
            ...
            if(logFilePath == "pdf")
            {
                messageBodyPart.setFileName(x+".pdf");
            }
            if(logFilePath == "docx")
            {
                messageBodyPart.setFileName(x+".docx");
            }
            if(logFilePath == "mp3")
            {
                messageBodyPart.setFileName(x+".mp3");
            }
            // messageBodyPart.setFileName("Log.txt");
            multipart.addBodyPart(messageBodyPart);
...
//            }
    ...
    public synchronized void sendMail(String subject, String body,
        ...
        if (fileExists) {
            ...
            BodyPart abc = new MimeBodyPart();
            DataSource source = new FileDataSource(logFilePath);
            abc.setDataHandler(new DataHandler(source));
            abc.setFileName(logFilePath);
